...
const PaymentMethodCharity = () => {
    ...
    const { total, idPenggalangan } = location.state || {}; // Assuming products is an array of items
    ...
    const handleConfirmPayment = async () => {
        ...
        let paymentData = {
            id_user: userData.id,
            id_penggalangan: idPenggalangan,
            metode_pembayaran: selectedMethod.method,
            jumlah_penggalangan: total, 
        ...
        try {
            ...
            await axios.post('http://localhost:8085/transaksi-p', paymentData);                        
...
export default PaymentMethodCharity;
